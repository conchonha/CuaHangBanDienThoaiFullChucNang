...
class Fragment_7 : Fragment() {
    ...
    private var txtXemThem7: TextView? = null
    override fun onCreateView(
        inflater: LayoutInflater,
        container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        view1 = inflater.inflate(R.layout.fragment_7, container, false)
        anhxa()
        getdatasanpham()
        Onclickxemthem()
        return view1
    ...
    private fun Onclickxemthem() {
        txtXemThem7?.setOnClickListener {
    ...
    private fun anhxa() {
        txtXemThem7 = view1?.findViewById(R.id.txtxemthemvivo)
        arrayList = ArrayList()
