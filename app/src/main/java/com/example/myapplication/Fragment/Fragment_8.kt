...
class Fragment_8 : Fragment() {
    ...
    private var txtXemThem8: TextView? = null
    override fun onCreateView(
        inflater: LayoutInflater,
        container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        view1 = inflater.inflate(R.layout.fragment_8, container, false)
        anhxa()
        getdatasanpham()
        onclickcxemthem()
        return view1
    ...
    private fun onclickcxemthem() {
        txtXemThem8?.setOnClickListener {
    ...
    private fun anhxa() {
        txtXemThem8 = view1?.findViewById(R.id.txtxemthemsony)
        arrayList = ArrayList()
