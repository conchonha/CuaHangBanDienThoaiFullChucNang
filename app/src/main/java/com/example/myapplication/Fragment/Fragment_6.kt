...
class Fragment_6 : Fragment() {
    ...
    private var txtXemThem6: TextView? = null
    override fun onCreateView(
        inflater: LayoutInflater,
        container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View? {
        view1 = inflater.inflate(R.layout.fragment_6, container, false)
        anhxa()
        getdatasanpham()
        onclickxemthem()
        return view1
    ...
    private fun onclickxemthem() {
        txtXemThem6?.setOnClickListener {
    ...
    private fun anhxa() {
        txtXemThem6 = view1?.findViewById(R.id.txtrealme)
        arrayList = ArrayList()
